...
public class PessoaService {
    ...
    public Pessoa atualizar(Long id, Pessoa pessoaAtualizada) {
       ...
       // Verifica se o CPF já está cadastrado para outra pessoa
        if (!pessoaAtualizada.getCpf().equals(pessoaExistente.getCpf())
                && pessoaRepository.findByCpf(pessoaAtualizada.getCpf()) != null) {
        ...
        pessoaAtualizada.setName(pessoaExistente.getName());
